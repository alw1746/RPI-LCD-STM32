...
3. **TSpaint.ino** - enhanced version of Adafruit's touchpaint in https://github.com/adafruit/Adafruit_ILI9341. Plug in values returned by the XPT2046 controller. The XY values are mapped by the code to pixel coordinates(480x320). Z values(pressure) are used to vary  pen's stroke width. The heavier the pressure, the wider the stroke.
